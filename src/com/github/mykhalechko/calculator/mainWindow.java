package com.github.mykhalechko.calculator;
...
public class mainWindow {
    ...
    private JTextPane textPaneMainResult = new JTextPane();
    private JFrame frame;
    double inputNumber = 0;
    private double var1 = 0;
    private double var2 = 0;
    private double tempVar = 0;
    //	String tempInputNumberStr;
    private String operationStr = "0";
    ...
    private void buttonNumberClick(String s) {
        if (bool) {
    ...
    private void button0NumberClick() {
        if (!textPaneMainResult.getText().equals("0")) {
            buttonNumberClick("0");
        }
    }

    private void buttonComaMethod() {
    ...
    private void setOPerationTextPaneResult(String s) {
        operationStr = s;
    ...
    private void buttonEquallMethod() {
    ...
    private String getOutResultStr(String strOut) {
        strOut = strOut.replace(',', '.');
        return strOut;
    }

    private String setOutResultStr(String strOut) {
    ...
    private void backSpaceButtonMethod() {
